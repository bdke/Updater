    ...
    async def help(self, ctx, *input):
        ...
        if not input:
            ...
            emb.add_field(name="About", value=f"The Bots is developed by {owner_name}, based on discord.py.\n\
                                    ...
                                    Please visit https://github.com/bdke/updaterbot to submit ideas or bugs.")
        ...
        # trying to find matching cog and it's commands
            ...
            # yes, for-loops have an else statement, it's called when no 'break' was issued
                ...
                emb = discord.Embed(title="Module not found",
                                    description=f"unable to find module `{input[0]}`",
        ...
        # too many cogs requested - only one at a time allowed
            ...
            emb = discord.Embed(title="Invalid input",
                                description="I don't know how you got here. But I didn't see this coming at all.\n"
                                            ...
                                            "https://github.com/bdke/updaterbot\n"
                                            "Thank you! ~fromost",
